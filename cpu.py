...
class CPU:
    ...
    def __init__(self):
        ...
        self.ram = [0] * 256
        self.sp = 7 # 0xf3 # stack pointer - points at the value at the top of the stack 
        self.fl = 0b00000000
    ...
    def run(self):
        ...
        while True:
            ...
            #     self.pc +=2
                ...
                print(f'Unsupported operation: instruction_register{hex(instruction_register)} not recognized')
                break
    ...
    def ram_read(self, address_to_read):
        """ read the ram MAR: Memory Address Register, accept the address to read and return the value stored
there."""
        return self.ram[address_to_read]

    def ram_write(self, address_to_read, register_to_write_to):
        """writes to ram MDR: Memory Data Register, accept a value to write, and the address to write it to."""
